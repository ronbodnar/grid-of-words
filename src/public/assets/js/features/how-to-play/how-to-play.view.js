...
const buildStepContainer = () => {
  ...
  const steps = [
    ...
    "If the square is <span class='square' style='padding: 5px 10px; font-size: 20px; background: var(--no-match)'>dark</span>, the letter does not exist in the word.",
    "If the square is <span class='square' style='padding: 5px 10px; font-size: 20px; background: var(--partial-match)'>orange</span>, the letter is not in the correct position in the word.",
    "If the square is <span class='square' style='padding: 5px 10px; font-size: 20px; background: var(--exact-match)'>green</span>, the letter is in the correct position in the word.",
