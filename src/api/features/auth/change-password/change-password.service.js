...
export const changePassword = async (newPassword, currentPassword, authToken) => {
  if (newPassword === currentPassword) {
    return new ValidationError('New password cannot be the same as the current password.')
  }
  ...
  if (!authenticatedUser) {
    ...
    return new UnauthorizedError('Please log out and back in to change your password.')
  }
  ...
  if (actualPasswordHash !== providedPasswordHash) {
    return new UnauthorizedError('The current password you provided is not correct.')
  }
